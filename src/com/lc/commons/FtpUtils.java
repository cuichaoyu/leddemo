...
public class FtpUtils {
     ...
     * @return
     */
    public static boolean uploadFile(FTPClient ftpClient,String pathname,String originfilename){
        boolean flag = false;
        InputStream inputStream = null;
        try{
            File file = new File(originfilename) ;
            ftpClient.changeWorkingDirectory("/"); // 回到根目录
            if(!existFile(ftpClient,pathname + "/" + file.getName())){
    ...
    public static boolean uploadFile(FTPClient ftpClient,String pathname,String fileName,String originfilename){
        ...
        InputStream inputStream = null;
        try{
            if(!existFile(ftpClient,pathname + "/" + fileName)){
                System.out.println("开始上传文件");
    ...
    public  static boolean downloadFile(FTPClient ftpClient,String pathname, String filename, String localpath){
        ...
        boolean isHaveFile = false ; // 是否有文件
        try {
            ...
            if(flag){
                ...
                System.out.println("下载文件失败" + (isHaveFile ? "":",找不到该文件"));
            }
        } catch (Exception e) {
